var gt=Object.defineProperty;var mt=(L,z,R)=>z in L?gt(L,z,{enumerable:!0,configurable:!0,writable:!0,value:R}):L[z]=R;var et=(L,z,R)=>mt(L,typeof z!="symbol"?z+"":z,R);import{g as ft}from"./CqkleIqs.js";var D={exports:{}},kt=D.exports,nt;function wt(){return nt||(nt=1,(function(L,z){(function(R,S){L.exports=S()})(kt,(function(){function R(){return{async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}let S={async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1};const H=/[&<>"']/,st=new RegExp(H.source,"g"),j=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,it=new RegExp(j.source,"g"),rt={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},B=h=>rt[h];function b(h,n){if(n){if(H.test(h))return h.replace(st,B)}else if(j.test(h))return h.replace(it,B);return h}const at=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;function J(h){return h.replace(at,((n,t)=>(t=t.toLowerCase())==="colon"?":":t.charAt(0)==="#"?t.charAt(1)==="x"?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1)):""))}const ot=/(^|[^\[])\^/g;function k(h,n){h=typeof h=="string"?h:h.source,n=n||"";const t={replace:(e,s)=>(s=(s=s.source||s).replace(ot,"$1"),h=h.replace(e,s),t),getRegex:()=>new RegExp(h,n)};return t}const lt=/[^\w:]/g,ct=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function Q(h,n,t){if(h){let e;try{e=decodeURIComponent(J(t)).replace(lt,"").toLowerCase()}catch{return null}if(e.indexOf("javascript:")===0||e.indexOf("vbscript:")===0||e.indexOf("data:")===0)return null}n&&!ct.test(t)&&(t=(function(e,s){q[" "+e]||(ut.test(e)?q[" "+e]=e+"/":q[" "+e]=N(e,"/",!0)),e=q[" "+e];const a=e.indexOf(":")===-1;return s.substring(0,2)==="//"?a?s:e.replace(pt,"$1")+s:s.charAt(0)==="/"?a?s:e.replace(dt,"$1")+s:e+s})(n,t));try{t=encodeURI(t).replace(/%25/g,"%")}catch{return null}return t}const q={},ut=/^[^:]+:\/*[^/]*$/,pt=/^([^:]+:)[\s\S]*$/,dt=/^([^:]+:\/*[^/]*)[\s\S]*$/,P={exec:function(){}};function W(h,n){const t=h.replace(/\|/g,((s,a,r)=>{let i=!1,o=a;for(;--o>=0&&r[o]==="\\";)i=!i;return i?"|":" |"})).split(/ \|/);let e=0;if(t[0].trim()||t.shift(),t.length>0&&!t[t.length-1].trim()&&t.pop(),t.length>n)t.splice(n);else for(;t.length<n;)t.push("");for(;e<t.length;e++)t[e]=t[e].trim().replace(/\\\|/g,"|");return t}function N(h,n,t){const e=h.length;if(e===0)return"";let s=0;for(;s<e;){const a=h.charAt(e-s-1);if(a!==n||t){if(a===n||!t)break;s++}else s++}return h.slice(0,e-s)}function K(h,n){if(n<1)return"";let t="";for(;n>1;)1&n&&(t+=h),n>>=1,h+=h;return t+h}function V(h,n,t,e){const s=n.href,a=n.title?b(n.title):null,r=h[1].replace(/\\([\[\]])/g,"$1");if(h[0].charAt(0)!=="!"){e.state.inLink=!0;const i={type:"link",raw:t,href:s,title:a,text:r,tokens:e.inlineTokens(r)};return e.state.inLink=!1,i}return{type:"image",raw:t,href:s,title:a,text:b(r)}}class U{constructor(n){this.options=n||S}space(n){const t=this.rules.block.newline.exec(n);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(n){const t=this.rules.block.code.exec(n);if(t){const e=t[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?e:N(e,`
...
`)})(e,t[3]||"");return{type:"code",raw:e,lang:t[2]?t[2].trim().replace(this.rules.inline._escapes,"$1"):t[2],text:s}}}heading(n){const t=this.rules.block.heading.exec(n);if(t){let e=t[2].trim();if(/#$/.test(e)){const s=N(e,"#");this.options.pedantic?e=s.trim():s&&!/ $/.test(s)||(e=s.trim())}return{type:"heading",raw:t[0],depth:t[1].length,text:e,tokens:this.lexer.inline(e)}}}hr(n){const t=this.rules.block.hr.exec(n);if(t)return{type:"hr",raw:t[0]}}blockquote(n){const t=this.rules.block.blockquote.exec(n);if(t){const e=t[0].replace(/^ *>[ \t]?/gm,""),s=this.lexer.state.top;this.lexer.state.top=!0;const a=this.lexer.blockTokens(e);return this.lexer.state.top=s,{type:"blockquote",raw:t[0],tokens:a,text:e}}}list(n){let t=this.rules.block.list.exec(n);if(t){let e,s,a,r,i,o,c,d,l,u,w,T,y=t[1].trim();const _=y.length>1,f={type:"list",raw:"",ordered:_,start:_?+y.slice(0,-1):"",loose:!1,items:[]};y=_?`\\d{1,9}\\${y.slice(-1)}`:`\\${y}`,this.options.pedantic&&(y=_?y:"[*+-]");const I=new RegExp(`^( {0,3}${y})((?:[	 ][^\\n]*)?(?:\\n|$))`);for(;n&&(T=!1,t=I.exec(n))&&!this.rules.block.hr.test(n);){if(e=t[0],n=n.substring(e.length),d=t[2].split(`
